        ...
        @else
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center bg-info">
                    <h6 class="m-0 font-weight-bold text-primary text-light">Anda Memiliki Kesempatan Daftar TOEIC Gratis
                    </h6>
                </div>
                <div class="card-body">
                    <form id="formPendaftaran" action="{{ route('mahasiswa.pendaftaran.create_formulir_proses') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                                ...
                                <div class="card border-left-primary mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @else
                                            ...
                                            <div class="form-group row">
                                                <label for="jadwal_id"
                                                    class="col-md-4 col-form-label font-weight-bold">Pilih
                                                    Jadwal</label>
                                                <div class="col-md-8">
